...
GraphicsVisualizer::GraphicsVisualizer(LunaAudioProcessor& p, std::function<const juce::AudioBuffer<float>&()> bufferGetterInput, juce::Colour colorInput)
    : bufferGetter(bufferGetterInput), graphicsColor(colorInput), processor(p), partsHeight(PARTS, 0.0f)
{
    setSize (300, 225);
...
//==============================================================================
void GraphicsVisualizer::update()
{
    const auto& delayBuffer = bufferGetter();
...
//==============================================================================
void GraphicsVisualizer::paint (juce::Graphics& g)
{
    // Background Color
...
void GraphicsVisualizer::resized()
{
...
void GraphicsVisualizer::addNewSample(float newSample, int sampleAmt)
{
